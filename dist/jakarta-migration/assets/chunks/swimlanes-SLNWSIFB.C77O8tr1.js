const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/sizeCapture-X5ZJPWSS.DlNBZ5Dr.js","assets/app.CHtHelNj.js","assets/chunks/framework.CHIFnItg.js","assets/chunks/theme.wO3w5b6Q.js"])))=>i.map(i=>d[i]);
import { V as __vitePreload } from "./framework.CHIFnItg.js";
import { c as clear$2 } from "./chunk-RYQCIY6F.DFLrX-YP.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, z as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, y as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "../app.CHtHelNj.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS.DlNBZ5Dr.js");
